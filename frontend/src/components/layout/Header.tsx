...
const ref = useRef<null | HTMLDivElement>(null); 
  ...
  return (
   <div className='w-full flex justify-center relative  '>
      <div onClick={() => handleScroll(-500)} style={{ cursor: "pointer" }} className=' absolute left-3 md:left-[90px] z-50 top-12 bg-white rounded-full'>
     ...
     <div className='flex w-[80%] overflow-x-hidden relative' ref={ref}  >
      {
        ...
        <div onClick={() => handleScroll(500)} style={{ cursor: "pointer" }} className=' absolute right-3 md:right-[90px] z-50 top-12 bg-white rounded-full'>
